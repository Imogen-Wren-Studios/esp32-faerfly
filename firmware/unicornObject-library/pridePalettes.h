...
#include <FastLED.h>
 ...
 extern  DEFINE_GRADIENT_PALETTE(gay){
  ...
  extern DEFINE_GRADIENT_PALETTE(ace){
  ...
  extern DEFINE_GRADIENT_PALETTE(aero){
    0, 131, 87, 20,      // mud   0
  ...
  extern DEFINE_GRADIENT_PALETTE(inter){
    0, 0, 200, 255,      // Blue  0
    40, 0, 0, 255,       //gravel 1
  ...
  extern DEFINE_GRADIENT_PALETTE(demi){
    0, 0, 0, 255,        // Blue  0
    40, 0, 0, 255,       //gravel 1
    42, 0, 0, 255,       // dirty orange (very thin) 2
    45, 202, 255, 255,   //tan_suit 3
 ...
 extern  DEFINE_GRADIENT_PALETTE(queer){
